...
频率节点。源合同见 [S4b 接口](GPU_RESOURCE_S4B_INTERFACE.md)，验收门槛及各次
仪器更正见 [预登记计划](GPU_RESOURCE_S4B_PLAN_2026-09-06.md)。
...
或凭证。见 [有界审计](GPU_RESOURCE_S4B_AUDIT_2026-09-06.json)。
