...
- [ ] 有线波形质量：统一RX50的24类Z30有限覆盖已完成；16QAM首保护区及零星载荷异常、AM估计/模型限制、长期稳定和低源SNR仍未解决。局部有限验证不完成稳定全库质量、物理SINR校准或生产准入。
...
- [ ] 多类校正稳定性与低源SNR覆盖：统一RX50的24类Z30有限确认已完成；保护区及个别载荷异常、AM源混淆/估计限制保留，物理来源与长期稳定未确定。低源SNR分层尚未完成，不因548/576与本批源正确数相同而宣布全库质量通过。
