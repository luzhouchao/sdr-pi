...
- [ ] 26档封存语料冻结模型识别：按用户最新要求停止8192任务、删除旧batch1/batch8192结果，并以GPU batch1024从头执行完整三组对照。原始语料不改、不重发；当前进度及完整2496块结果以batch1024根state/complete/retention为准，见[切换记录](validation/RML2018A_FULL_RF_CAMPAIGN_2026-09-10.md#2026-09-141024批量重跑与旧结果删除)。
