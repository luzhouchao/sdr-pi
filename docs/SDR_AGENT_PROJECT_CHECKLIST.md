...
- [ ] 有线波形质量：原始配对组条件SINR仍约+6.91～+10.02dB；保护间隔相消在既有两类48条回放提高至18.29～20.80dB，但尚未接入新采集、24类或低源SNR验证。有限回放通过不完成此项、物理SINR校准或全库准入。
...
- [ ] 导频驱动的时序校正及新采集验证：仅用已知导频估计分数延迟/漂移，验证独立留出和调制保真，再与固定LO相消一起接入有界新采集；当前源辅助诊断及导频观察不完成此项。
