...
- [ ] 全量四窗联合重识别完成与比较：batch1024单次后台服务已启动，source/raw/guard每种预期638976组覆盖2555904源行；成功单窗结果保留，待全26档完成、独立血缘/统计复核及退出清理。见[四窗记录](validation/RML2018A_FULL_RF_CAMPAIGN_2026-09-10.md#2026-09-14全量四窗联合识别)。
...
- [ ] 外接硬盘全26档IQ副本完成：一次后台复制服务active，待全部2802文件传输及读回SHA通过、COPY_COMPLETE.json生成和服务退出；未宣称完整备份。见[复制记录](validation/RML2018A_FULL_RF_CAMPAIGN_2026-09-10.md#2026-09-14外接硬盘iq副本)。
