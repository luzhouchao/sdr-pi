...
- [ ] D10替换D8重跑当前2496成员离线对照（2026-09-22用户授权）：权重SHA及CPU读取通过；缺对应D10计算图，等待源码/连接，未严格加载或新推理。见[预检与完成边界](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#d10替换重跑预检2026-09-22)。
