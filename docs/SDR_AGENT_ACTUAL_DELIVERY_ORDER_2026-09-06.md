...
[验证](validation/RML2018A_FULL_RF_CAMPAIGN_2026-09-10.md)。当前下一单元是定位433MHz接收失真，
先按旧175kHz FIR源保真门，对当前保留72条做固定原始/滤波推理对照，区分输入污染与剩余失真，
再决定采集诊断和扩量；不把离线相关改善等同于识别或全库质量通过。
