...
基线f7171ae；执行[登记计划](B210_LO_REJECTION_PLAN_2026-09-07.md)。**已实现并
...
完整有界记录见[审计](B210_LO_REJECTION_AUDIT_2026-09-07.json)。
...
![固定滤波前后的频谱和全段RMS](B210_LO_REJECTION_OVERVIEW_2026-09-07.png)
...
[证据登记](B210_LO_REJECTION_EVIDENCE_2026-09-07.json)。用户原有语料和结果未动。
