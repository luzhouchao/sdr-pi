...
基线b23fe92，按[预登记计划](../evidence/B210_RX1_NEW_ANTENNA_PLAN_2026-09-07.md)执行。
用户确认新2.4/5GHz双频天线接回P201 RX1；本次不再操作RX2选择。
完整决策指标及全量中间分析的可复现hash见
[审计](../evidence/B210_RX1_NEW_ANTENNA_AUDIT_2026-09-07.json)，原始证据路径、hash及人工
删除方法见[库存](../evidence/B210_RX1_NEW_ANTENNA_EVIDENCE_2026-09-07.json)。
...
![固定窗口相关性与分时背景对照](../evidence/B210_RX1_NEW_ANTENNA_OVERVIEW_2026-09-07.png)
