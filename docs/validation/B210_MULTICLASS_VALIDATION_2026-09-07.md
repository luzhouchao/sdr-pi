...
![逐类对照](../evidence/B210_MULTICLASS_OVERVIEW_2026-09-07.png)
...
- [预注册](../evidence/B210_MULTICLASS_PLAN_2026-09-07.md)；
...
- 固定 offset32768 的连续4096点，原始源不作接收拟合、相位/增益补偿或有利窗口搜索；
  ...
  [审计](../evidence/B210_MULTICLASS_AUDIT_2026-09-07.json)。数字ID可信，输出均为未校准诊断。
...
（约59.57 MiB）。[完整库存](../evidence/B210_MULTICLASS_EVIDENCE_2026-09-07.json) 登记逐文件
