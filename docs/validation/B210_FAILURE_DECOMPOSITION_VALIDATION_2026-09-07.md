...
基线5a726d8；按[后验方法登记](../evidence/B210_FAILURE_DECOMPOSITION_PLAN_2026-09-07.md)，
只读分析既有ABBA证据。没有新增RF、模型/warmup、dataset/test读取或生产修改。
原low1成功与其余三组失败全部保持，详情见
[有界审计](../evidence/B210_FAILURE_DECOMPOSITION_AUDIT_2026-09-07.json)。
...
![相位/频差/时延解释能力与保护频带](../evidence/B210_FAILURE_DECOMPOSITION_OVERVIEW_2026-09-07.png)
