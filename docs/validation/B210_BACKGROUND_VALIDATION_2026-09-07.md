...
基线5c23cab。复核旧保留IQ后，按[执行前计划](../evidence/B210_BACKGROUND_PLAN_2026-09-07.md)
完成30次纯接收。**背景具有明显的时间变化和频率差异；2455 MHz相比2440 MHz
的强突发有所减轻，但不能宣布已经找到合格的安静频点。** 本轮没有TX或模型。
完整统计、身份/hash和恢复见[审计](../evidence/B210_BACKGROUND_AUDIT_2026-09-07.json)。
...
![发现矩阵、独立确认及第一对确认频谱](../evidence/B210_BACKGROUND_OVERVIEW_2026-09-07.png)
...
[证据登记](../evidence/B210_BACKGROUND_EVIDENCE_2026-09-07.json)。发现阶段24份IQ和构建、
