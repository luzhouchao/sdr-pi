...
现用展示已按用户要求由D10替代D8，只显示raw/guard。当前8模型同2496成员，
其余7模型同369497成员；[最新图表](../validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#当前图表以d10替代d82026-09-22)。
下文D8任务与8模型旧集合均为历史执行记录，不是当前模型选择。
