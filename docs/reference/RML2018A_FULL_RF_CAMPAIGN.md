...
2026-09-13最新接线为P201 RX1独立50Ω负载、B210停发，见[负载对照](../validation/RML2018A_FULL_RF_CAMPAIGN_2026-09-10.md#2026-09-13p201独立50ω负载与同轴控制比较)。
下面的同轴收发参数是回放参考，恢复TX前须确认用户已接回20dB同轴链路。
