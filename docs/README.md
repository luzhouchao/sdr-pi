...
当前模型重跑：2026-09-22用户指定D10替换D8，同2496成员重跑完成，低源SNR相消退化仍存在；后续载荷特征排查不支持中心载波误删，因果尚未确定，见[排查](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#d10低源snr载荷特征排查2026-09-22)及[结果](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#d10同成员重跑完成2026-09-22)及当前执行选择。
