...
2026-09-26固定25%相消已在剩余367001共同成员检验：总体53.92%低于完全相消55.10%，
低SINR退化减轻但仍低于raw，不采用固定25%替代；见[后续结果](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#固定25相消的剩余共同成员验证2026-09-26)。
条件SINR依赖源参考，不可直接作为在线开关；未启用新规则、训练或传输。
