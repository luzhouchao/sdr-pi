...
当前实测报告：按用户要求统一采用接收端条件估计SINR。8模型369497共同验证成员、
9模型2496诊断成员的配对分层及各自SINR曲线已完成，源SNR仅溯源；
见[SINR重分层](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#实测结果按接收sinr重分层2026-09-22)。
