...
当前模型排查：D10总功率匹配对照完成，三宽带扰动未重现窄带回添收益，
总功率不足以解释低源SNR分类变化；诊断收束，保留频谱结构/模型响应与内部机制边界。
见[最终对照及论文表述](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#d10总功率匹配对照与诊断收束2026-09-22)及当前执行选择。
