...
[后续实验选择](SDR_AGENT_ACTUAL_DELIVERY_ORDER_2026-09-06.md#后续实验选择)。既有ADC离线诊断后，当前选择为LO历史/资料复核及TX校准路径只读审计，暂不重新收发或微调；完成结果见[离线报告](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md)。
