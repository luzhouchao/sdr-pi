...
当前模型排查：D10固定尺度窄带回添完成，支持低源SNR分类对窄带存在/强度/位置的响应；
精确原相位不是总体准确率恢复的必要条件，内部机制与功率/结构贡献尚未确定。
见[最新回添对照](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#d10固定尺度窄带回添对照2026-09-22)及当前执行选择。
