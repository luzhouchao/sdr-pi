...
当前实测报告：D10已取代D8，当前8模型共同2496成员的raw/guard SINR曲线和配对表
已更新，不再列D8或source；其余7模型的369497共同成员另列，D10未扩充到该范围。
见[当前模型图表](validation/RML2018A_OFFLINE_BASELINE_2026-09-16.md#当前图表以d10替代d82026-09-22)。
原D10机制诊断已收束，不据分层结果启用自动阈值或新训练。
