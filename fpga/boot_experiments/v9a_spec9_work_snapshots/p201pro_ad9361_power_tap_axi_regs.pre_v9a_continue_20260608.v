...
(
    ...
    localparam [11:0] REG_SPEC_PEAK_LO     = 12'h214;
    localparam [11:0] REG_SPEC_PEAK_HI     = 12'h218;
    localparam [11:0] REG_SPEC_TOTAL_LO    = 12'h21c;
    localparam [11:0] REG_SPEC_TOTAL_HI    = 12'h220;
    localparam [11:0] REG_SPEC_NOISE_LO    = 12'h224;
    localparam [11:0] REG_SPEC_NOISE_HI    = 12'h228;
    localparam [11:0] REG_SPEC_PROM_LO     = 12'h22c;
    localparam [11:0] REG_SPEC_PROM_HI     = 12'h230;
    localparam [11:0] REG_SPEC_BIN0_LO     = 12'h234;
    localparam [11:0] REG_SPEC_BIN0_HI     = 12'h238;
    localparam [11:0] REG_SPEC_BIN1_LO     = 12'h23c;
    localparam [11:0] REG_SPEC_BIN1_HI     = 12'h240;
    localparam [11:0] REG_SPEC_BIN2_LO     = 12'h244;
    localparam [11:0] REG_SPEC_BIN2_HI     = 12'h248;
    localparam [11:0] REG_SPEC_BIN3_LO     = 12'h24c;
    localparam [11:0] REG_SPEC_BIN3_HI     = 12'h250;
    localparam [11:0] REG_SPEC_CAP         = 12'h2f4;
    localparam [11:0] REG_SPEC_BUILD_ID    = 12'h2f8;
    localparam [11:0] REG_SPEC_LIMIT       = 12'h2fc;
    ...
    localparam [31:0] SPEC_BIN_COUNT       = 32'd4;
    ...
    reg [39:0] summary_spec_bin0_mag_adc;
    reg [39:0] summary_spec_bin1_mag_adc;
    reg [39:0] summary_spec_bin2_mag_adc;
    reg [39:0] summary_spec_bin3_mag_adc;
    reg [39:0] summary_spec_peak_mag_adc;
    reg [39:0] summary_spec_total_mag_adc;
    reg [39:0] summary_spec_noise_mag_adc;
    reg [39:0] summary_spec_prominence_adc;
    ...
    reg [39:0] summary_spec_bin0_mag_axi;
    reg [39:0] summary_spec_bin1_mag_axi;
    reg [39:0] summary_spec_bin2_mag_axi;
    reg [39:0] summary_spec_bin3_mag_axi;
    reg [39:0] summary_spec_peak_mag_axi;
    reg [39:0] summary_spec_total_mag_axi;
    reg [39:0] summary_spec_noise_mag_axi;
    reg [39:0] summary_spec_prominence_axi;
    ...
    wire signed [31:0] adc_i_s32 = {{16{adc_i[15]}}, adc_i};
    wire signed [31:0] adc_q_s32 = {{16{adc_q[15]}}, adc_q};
    ...
    wire [32:0] spec_bin0_abs_re = spec_bin0_re_adc[31] ? {1'b0, ((~spec_bin0_re_adc) + 32'd1)} : {1'b0, spec_bin0_re_adc};
    wire [32:0] spec_bin0_abs_im = spec_bin0_im_adc[31] ? {1'b0, ((~spec_bin0_im_adc) + 32'd1)} : {1'b0, spec_bin0_im_adc};
    wire [32:0] spec_bin1_abs_re = spec_bin1_re_adc[31] ? {1'b0, ((~spec_bin1_re_adc) + 32'd1)} : {1'b0, spec_bin1_re_adc};
    wire [32:0] spec_bin1_abs_im = spec_bin1_im_adc[31] ? {1'b0, ((~spec_bin1_im_adc) + 32'd1)} : {1'b0, spec_bin1_im_adc};
    wire [32:0] spec_bin2_abs_re = spec_bin2_re_adc[31] ? {1'b0, ((~spec_bin2_re_adc) + 32'd1)} : {1'b0, spec_bin2_re_adc};
    wire [32:0] spec_bin2_abs_im = spec_bin2_im_adc[31] ? {1'b0, ((~spec_bin2_im_adc) + 32'd1)} : {1'b0, spec_bin2_im_adc};
    wire [32:0] spec_bin3_abs_re = spec_bin3_re_adc[31] ? {1'b0, ((~spec_bin3_re_adc) + 32'd1)} : {1'b0, spec_bin3_re_adc};
    wire [32:0] spec_bin3_abs_im = spec_bin3_im_adc[31] ? {1'b0, ((~spec_bin3_im_adc) + 32'd1)} : {1'b0, spec_bin3_im_adc};
    wire [39:0] spec_bin0_mag_next = {7'd0, (spec_bin0_abs_re + spec_bin0_abs_im)};
    wire [39:0] spec_bin1_mag_next = {7'd0, (spec_bin1_abs_re + spec_bin1_abs_im)};
    wire [39:0] spec_bin2_mag_next = {7'd0, (spec_bin2_abs_re + spec_bin2_abs_im)};
    wire [39:0] spec_bin3_mag_next = {7'd0, (spec_bin3_abs_re + spec_bin3_abs_im)};
    wire [39:0] spec_total_mag_next = spec_bin0_mag_next + spec_bin1_mag_next + spec_bin2_mag_next + spec_bin3_mag_next;
    wire [39:0] spec_peak01_mag = (spec_bin0_mag_next >= spec_bin1_mag_next) ? spec_bin0_mag_next : spec_bin1_mag_next;
    wire [1:0]  spec_peak01_bin = (spec_bin0_mag_next >= spec_bin1_mag_next) ? 2'd0 : 2'd1;
    wire [39:0] spec_peak23_mag = (spec_bin2_mag_next >= spec_bin3_mag_next) ? spec_bin2_mag_next : spec_bin3_mag_next;
    wire [1:0]  spec_peak23_bin = (spec_bin2_mag_next >= spec_bin3_mag_next) ? 2'd2 : 2'd3;
    wire [39:0] spec_peak_mag_next = (spec_peak01_mag >= spec_peak23_mag) ? spec_peak01_mag : spec_peak23_mag;
    wire [1:0]  spec_peak_bin_next = (spec_peak01_mag >= spec_peak23_mag) ? spec_peak01_bin : spec_peak23_bin;
    wire [39:0] spec_max_other0 = (spec_bin1_mag_next >= spec_bin2_mag_next) ?
                                  ((spec_bin1_mag_next >= spec_bin3_mag_next) ? spec_bin1_mag_next : spec_bin3_mag_next) :
                                  ((spec_bin2_mag_next >= spec_bin3_mag_next) ? spec_bin2_mag_next : spec_bin3_mag_next);
    wire [39:0] spec_max_other1 = (spec_bin0_mag_next >= spec_bin2_mag_next) ?
                                  ((spec_bin0_mag_next >= spec_bin3_mag_next) ? spec_bin0_mag_next : spec_bin3_mag_next) :
                                  ((spec_bin2_mag_next >= spec_bin3_mag_next) ? spec_bin2_mag_next : spec_bin3_mag_next);
    wire [39:0] spec_max_other2 = (spec_bin0_mag_next >= spec_bin1_mag_next) ?
                                  ((spec_bin0_mag_next >= spec_bin3_mag_next) ? spec_bin0_mag_next : spec_bin3_mag_next) :
                                  ((spec_bin1_mag_next >= spec_bin3_mag_next) ? spec_bin1_mag_next : spec_bin3_mag_next);
    wire [39:0] spec_max_other3 = (spec_bin0_mag_next >= spec_bin1_mag_next) ?
                                  ((spec_bin0_mag_next >= spec_bin2_mag_next) ? spec_bin0_mag_next : spec_bin2_mag_next) :
                                  ((spec_bin1_mag_next >= spec_bin2_mag_next) ? spec_bin1_mag_next : spec_bin2_mag_next);
    wire [39:0] spec_min_other0 = (spec_bin1_mag_next <= spec_bin2_mag_next) ?
                                  ((spec_bin1_mag_next <= spec_bin3_mag_next) ? spec_bin1_mag_next : spec_bin3_mag_next) :
                                  ((spec_bin2_mag_next <= spec_bin3_mag_next) ? spec_bin2_mag_next : spec_bin3_mag_next);
    wire [39:0] spec_min_other1 = (spec_bin0_mag_next <= spec_bin2_mag_next) ?
                                  ((spec_bin0_mag_next <= spec_bin3_mag_next) ? spec_bin0_mag_next : spec_bin3_mag_next) :
                                  ((spec_bin2_mag_next <= spec_bin3_mag_next) ? spec_bin2_mag_next : spec_bin3_mag_next);
    wire [39:0] spec_min_other2 = (spec_bin0_mag_next <= spec_bin1_mag_next) ?
                                  ((spec_bin0_mag_next <= spec_bin3_mag_next) ? spec_bin0_mag_next : spec_bin3_mag_next) :
                                  ((spec_bin1_mag_next <= spec_bin3_mag_next) ? spec_bin1_mag_next : spec_bin3_mag_next);
    wire [39:0] spec_min_other3 = (spec_bin0_mag_next <= spec_bin1_mag_next) ?
                                  ((spec_bin0_mag_next <= spec_bin2_mag_next) ? spec_bin0_mag_next : spec_bin2_mag_next) :
                                  ((spec_bin1_mag_next <= spec_bin2_mag_next) ? spec_bin1_mag_next : spec_bin2_mag_next);
    wire [39:0] spec_max_other_next =
        (spec_peak_bin_next == 2'd0) ? spec_max_other0 :
        (spec_peak_bin_next == 2'd1) ? spec_max_other1 :
        (spec_peak_bin_next == 2'd2) ? spec_max_other2 : spec_max_other3;
    wire [39:0] spec_noise_mag_next =
        (spec_peak_bin_next == 2'd0) ? spec_min_other0 :
        (spec_peak_bin_next == 2'd1) ? spec_min_other1 :
        (spec_peak_bin_next == 2'd2) ? spec_min_other2 : spec_min_other3;
    wire [39:0] spec_prominence_next = (spec_peak_mag_next > spec_max_other_next) ? (spec_peak_mag_next - spec_max_other_next) : 40'd0;
    wire spec_valid_next = (final_sample_count_adc[1:0] == 2'd0);
