...
// V9B0 minimal-isolation candidate:
// keep SUM/QUA/AGG behavior, disable the V9A SPEC9 page/datapath.
...
(
    ...
    localparam [31:0] SUMMARY_VERSION_V9B0 = 32'h53394230;
    ...
    localparam [31:0] SUMMARY_BUILD_ID     = 32'h56394230;
    localparam [31:0] QUALITY_VERSION_V9B0 = 32'h51394230;
    localparam [31:0] QUALITY_CAPABILITY   = 32'h0000000f;
    localparam [31:0] QUALITY_BUILD_ID     = 32'h51394230;
    localparam [31:0] AGG_VERSION_V9B0     = 32'h41394230;
    localparam [31:0] AGG_CAPABILITY       = 32'h0000001f;
    localparam [31:0] AGG_BUILD_ID         = 32'h41394230;
    localparam [31:0] AGG_MAX_FRAMES       = 32'd65535;
    localparam [31:0] SPEC_VERSION_DISABLED = 32'd0;
    localparam [31:0] SPEC_CAPABILITY       = 32'd0;
    localparam [31:0] SPEC_BUILD_ID         = 32'd0;
    localparam [31:0] SPEC_ABI_VERSION      = 32'd0;
    localparam [31:0] SPEC_BIN_COUNT_VALUE  = 32'd0;
        ...
        if (!s_axi_aresetn_read_axi) begin
            ...
            if (!s_axi_rvalid && s_axi_arvalid) begin
                ...
                case (s_axi_araddr[11:0])
                    ...
                    REG_SUMMARY_VERSION:  s_axi_rdata <= SUMMARY_VERSION_V9B0;
                    ...
                    REG_QUALITY_VERSION:  s_axi_rdata <= QUALITY_VERSION_V9B0;
                    ...
                    REG_AGG_VERSION:      s_axi_rdata <= AGG_VERSION_V9B0;
                    ...
                    REG_SPEC_VERSION:     s_axi_rdata <= SPEC_VERSION_DISABLED;
                    REG_SPEC_FLAGS:       s_axi_rdata <= 32'd0;
                    REG_SPEC_FRAME:       s_axi_rdata <= 32'd0;
                    REG_SPEC_SAMPLES:     s_axi_rdata <= 32'd0;
                    REG_SPEC_PEAK_BIN:    s_axi_rdata <= 32'd0;
                    REG_SPEC_PEAK_POWER:  s_axi_rdata <= 32'd0;
                    REG_SPEC_TOTAL_POWER: s_axi_rdata <= 32'd0;
                    REG_SPEC_NOISE_FLOOR: s_axi_rdata <= 32'd0;
                    REG_SPEC_PROMINENCE:  s_axi_rdata <= 32'd0;
                    REG_SPEC_BIN0_POWER:  s_axi_rdata <= 32'd0;
                    REG_SPEC_BIN1_POWER:  s_axi_rdata <= 32'd0;
                    REG_SPEC_BIN2_POWER:  s_axi_rdata <= 32'd0;
                    REG_SPEC_BIN3_POWER:  s_axi_rdata <= 32'd0;
                    REG_SPEC_LIMIT_FLAGS: s_axi_rdata <= 32'd0;
                    REG_SPEC_RX_MASK:     s_axi_rdata <= 32'd0;
