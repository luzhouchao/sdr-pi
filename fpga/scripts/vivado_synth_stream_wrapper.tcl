...
set synth_dir [file join $repo_dir reports vivado_stream_wrapper_synth]
file mkdir $synth_dir

read_verilog [file join $hdl_dir p201pro_stream_power_axi_regs.v]

synth_design -top p201pro_stream_power_axi_regs -part xc7z020clg400-1
...
write_checkpoint -force [file join $synth_dir p201pro_stream_power_axi_regs_synth.dcp]
