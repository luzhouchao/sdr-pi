...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_integration_v9b0]
...
puts $fh "# AD9361 Power Tap BD Integration Report V9B0"
puts $fh ""
...
puts $fh "- V9B0 intent: rebuild BD against the V9B0 minimal-isolation IP package"
