...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_integration_v8d1_incremental_auto_roll_fix]
...
puts $fh "# AD9361 Power Tap BD Integration Report V8D1 Incremental Auto-Roll Fix"
puts $fh ""
...
puts $fh "- V8D1 intent: rebuild BD against the V8D1 continuous auto-roll fix IP package"
