...
set hdl_dir [file join $repo_dir boot_experiments sd_boot_rebuild_p201_summary_v9b0_minimal_isolation hdl]
set vivado_dir [file join $repo_dir vivado]
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_ip_v9b0]
set project_dir [file join $vivado_dir ad9361_tap_ip_packager_project_v9b0]
...
puts $fh "# Stage 4 AD9361 Tap IP Report V9B0"
puts $fh ""
...
puts $fh "- V9B0 intent: SUM/QUA/AGG identity only, SPEC page disabled/read-zero for AD9361 TX tuning isolation"
puts $fh ""
