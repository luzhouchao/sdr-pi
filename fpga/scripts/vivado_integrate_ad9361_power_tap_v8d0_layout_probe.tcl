...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_integration_v8d0_layout_probe]
...
puts $fh "# AD9361 Power Tap BD Integration Report V8D0 Layout Probe"
puts $fh ""
...
puts $fh "- V8D0 intent: rebuild BD against a V8L1-like build-ID-only layout probe IP package"
