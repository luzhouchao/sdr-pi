...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_ip]
set project_dir [file join $vivado_dir ad9361_tap_ip_packager_project]
...
puts $fh "# Stage 4 AD9361 Tap IP Report"
puts $fh ""
