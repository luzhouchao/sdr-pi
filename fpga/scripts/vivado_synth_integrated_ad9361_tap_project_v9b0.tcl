...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_integrated_synth_v9b0]
...
if {$synth_ok} {
    ...
    write_checkpoint -force [file join $reports_dir system_top_with_p201_tap_v9b0_synth.dcp]
}

set fh [open $report_file w]
puts $fh "# Integrated AD9361 Tap Synthesis Report V9B0"
puts $fh ""
...
puts $fh "- Synthesis checkpoint: `[file join $reports_dir system_top_with_p201_tap_v9b0_synth.dcp]`"
puts $fh "- V9B0 intent: integrated synthesis for SUM/QUA/AGG-only isolation candidate"
puts $fh ""
