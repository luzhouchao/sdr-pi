...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_integration_v8l1_auto_agg]
...
puts $fh "# AD9361 Power Tap BD Integration Report V8L1 Auto Aggregate"
puts $fh ""
...
puts $fh "- V8L1 intent: rebuild BD against the V8-derived AGG8 auto-roll IP package"
