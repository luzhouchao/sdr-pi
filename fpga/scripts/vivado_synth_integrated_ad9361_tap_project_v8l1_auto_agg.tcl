...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_integrated_synth_v8l1_auto_agg]
...
if {$synth_ok} {
    ...
    write_checkpoint -force [file join $reports_dir system_top_with_p201_tap_v8l1_auto_agg_synth.dcp]
}

set fh [open $report_file w]
puts $fh "# Integrated AD9361 Tap Synthesis Report V8L1 Auto Aggregate"
puts $fh ""
...
puts $fh "- Synthesis checkpoint: `[file join $reports_dir system_top_with_p201_tap_v8l1_auto_agg_synth.dcp]`"
puts $fh "- V8L1 intent: integrated synthesis for V8-derived AGG8 auto-roll candidate"
puts $fh ""
