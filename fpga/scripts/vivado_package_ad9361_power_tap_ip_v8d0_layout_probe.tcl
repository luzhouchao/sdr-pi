...
set hdl_dir [file join $repo_dir experiments v8d0_layout_probe hdl]
set vivado_dir [file join $repo_dir vivado]
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_ip_v8d0_layout_probe]
set project_dir [file join $repo_dir vivado_out ad9361_tap_ip_packager_project_v8d0_layout_probe]
...
puts $fh "# Stage 4 AD9361 Tap IP Report V8D0 Layout Probe"
puts $fh ""
...
puts $fh "- V8D0 intent: V8L1-like layout probe with build-ID-only HDL change"
puts $fh ""
