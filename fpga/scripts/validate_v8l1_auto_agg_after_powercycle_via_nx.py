...
def capture_agg(client: paramiko.SSHClient, frame_len: int, agg_frames: int, poll_sec: float, timeout_sec: float) -> dict:
    ...
    checks = {
        ...
        "agg_build_id_ok": agg_build == 0x41384C31,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate V8L1 auto aggregate after physical SDR power-cycle.")
    ...
    result: dict = {
        ...
        "operation": "validate_v8l1_auto_agg_after_powercycle_via_nx",
