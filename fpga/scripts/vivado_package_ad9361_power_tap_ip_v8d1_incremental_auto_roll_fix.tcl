...
set hdl_dir [file join $repo_dir experiments v8d1_incremental_auto_roll_fix hdl]
set vivado_dir [file join $repo_dir vivado]
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_ip_v8d1_incremental_auto_roll_fix]
set project_dir [file join $repo_dir vivado_out ad9361_tap_ip_packager_project_v8d1_incremental_auto_roll_fix]
...
puts $fh "# Stage 4 AD9361 Tap IP Report V8D1 Incremental Auto-Roll Fix"
puts $fh ""
...
puts $fh "- V8D1 intent: SUM8/QUA8/AGG8 continuous auto-roll fix prepared for V8L1-referenced incremental implementation"
puts $fh ""
