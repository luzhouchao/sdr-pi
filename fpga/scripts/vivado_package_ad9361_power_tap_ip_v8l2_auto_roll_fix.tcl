...
set reports_dir [file join $repo_dir reports stage4_ad9361_tap_ip_v8l2_auto_roll_fix]
set project_dir [file join $repo_dir vivado_out ad9361_tap_ip_packager_project_v8l2_auto_roll_fix]
...
puts $fh "# Stage 4 AD9361 Tap IP Report V8L2 Auto-Roll Fix"
puts $fh ""
...
puts $fh "- V8L2 intent: SUM8/QUA8/AGG8 continuous auto-roll low-NX-load candidate from pre-V9A snapshot"
puts $fh ""
