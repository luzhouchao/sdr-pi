...
(
    ...
    localparam [11:0] REG_SPEC_VERSION     = 12'h200;
    localparam [11:0] REG_SPEC_FLAGS       = 12'h204;
    localparam [11:0] REG_SPEC_FRAME       = 12'h208;
    localparam [11:0] REG_SPEC_SAMPLES     = 12'h20c;
    localparam [11:0] REG_SPEC_PEAK_BIN    = 12'h210;
    localparam [11:0] REG_SPEC_PEAK_POWER  = 12'h214;
    localparam [11:0] REG_SPEC_TOTAL_POWER = 12'h218;
    localparam [11:0] REG_SPEC_NOISE_FLOOR = 12'h21c;
    localparam [11:0] REG_SPEC_PROMINENCE  = 12'h220;
    localparam [11:0] REG_SPEC_BIN0_POWER  = 12'h224;
    localparam [11:0] REG_SPEC_BIN1_POWER  = 12'h228;
    localparam [11:0] REG_SPEC_BIN2_POWER  = 12'h22c;
    localparam [11:0] REG_SPEC_BIN3_POWER  = 12'h230;
    localparam [11:0] REG_SPEC_LIMIT_FLAGS = 12'h234;
    localparam [11:0] REG_SPEC_RX_MASK     = 12'h238;
    localparam [11:0] REG_SPEC_RESERVED0   = 12'h23c;
    localparam [11:0] REG_SPEC_BIN_COUNT   = 12'h2f0;
    localparam [11:0] REG_SPEC_CAP         = 12'h2f4;
    localparam [11:0] REG_SPEC_BUILD_ID    = 12'h2f8;
    localparam [11:0] REG_SPEC_ABI_VERSION = 12'h2fc;

    localparam [31:0] SUMMARY_VERSION_SUM9 = 32'h53554d39;
    localparam [31:0] SUMMARY_ABI_VERSION  = 32'h00010003;
    localparam [31:0] SUMMARY_CAPABILITY   = 32'h000007ff;
    localparam [31:0] SUMMARY_MAX_CORR_FRAME = 32'd65535;
    localparam [31:0] SUMMARY_BUILD_ID     = 32'h56390001;
    localparam [31:0] QUALITY_VERSION_SUM9 = 32'h51554139;
    localparam [31:0] QUALITY_CAPABILITY   = 32'h0000000f;
    localparam [31:0] QUALITY_BUILD_ID     = 32'h51390001;
    localparam [31:0] AGG_VERSION_SUM9     = 32'h41474739;
    localparam [31:0] AGG_CAPABILITY       = 32'h0000001f;
    localparam [31:0] AGG_BUILD_ID         = 32'h41390001;
    localparam [31:0] AGG_MAX_FRAMES       = 32'd65535;
    localparam [31:0] SPEC_VERSION_SUM9    = 32'h53504339;
    localparam [31:0] SPEC_CAPABILITY      = 32'h0000000f;
    localparam [31:0] SPEC_BUILD_ID        = 32'h53390001;
    localparam [31:0] SPEC_ABI_VERSION     = 32'h00010003;
    localparam [31:0] SPEC_BIN_COUNT_VALUE = 32'd4;
    ...
    reg        pending_adc;
    reg signed [15:0] adc_i_stage_adc;
    reg signed [15:0] adc_q_stage_adc;
    reg signed [15:0] adc_i1_stage_adc;
    reg signed [15:0] adc_q1_stage_adc;
    reg        adc_valid_stage_adc;
    reg        adc_valid1_stage_adc;
    ...
    reg signed [31:0] spec_bin0_re_adc;
    reg signed [31:0] spec_bin0_im_adc;
    reg signed [31:0] spec_bin1_re_adc;
    reg signed [31:0] spec_bin1_im_adc;
    reg signed [31:0] spec_bin2_re_adc;
    reg signed [31:0] spec_bin2_im_adc;
    reg signed [31:0] spec_bin3_re_adc;
    reg signed [31:0] spec_bin3_im_adc;
    reg [31:0] summary_spec_bin0_mag_adc;
    reg [31:0] summary_spec_bin1_mag_adc;
    reg [31:0] summary_spec_bin2_mag_adc;
    reg [31:0] summary_spec_bin3_mag_adc;
    reg [31:0] summary_spec_peak_mag_adc;
    reg [31:0] summary_spec_total_mag_adc;
    reg [31:0] summary_spec_noise_mag_adc;
    reg [31:0] summary_spec_prominence_adc;
    reg [31:0] summary_spec_limit_flags_adc;
    reg [1:0]  summary_spec_peak_bin_adc;
    reg        summary_spec_valid_adc;
    reg [32:0] spec_bin0_abs_re_stage_adc;
    reg [32:0] spec_bin0_abs_im_stage_adc;
    reg [32:0] spec_bin1_abs_re_stage_adc;
    reg [32:0] spec_bin1_abs_im_stage_adc;
    reg [32:0] spec_bin2_abs_re_stage_adc;
    reg [32:0] spec_bin2_abs_im_stage_adc;
    reg [32:0] spec_bin3_abs_re_stage_adc;
    reg [32:0] spec_bin3_abs_im_stage_adc;
    reg [39:0] spec_bin0_mag_stage_adc;
    reg [39:0] spec_bin1_mag_stage_adc;
    reg [39:0] spec_bin2_mag_stage_adc;
    reg [39:0] spec_bin3_mag_stage_adc;
    reg [39:0] spec_total_mag_stage_adc;
    reg [39:0] spec_pair01_high_mag_stage_adc;
    reg [39:0] spec_pair01_low_mag_stage_adc;
    reg [39:0] spec_pair23_high_mag_stage_adc;
    reg [39:0] spec_pair23_low_mag_stage_adc;
    reg [1:0]  spec_pair01_high_bin_stage_adc;
    reg [1:0]  spec_pair23_high_bin_stage_adc;
    reg [39:0] spec_peak_mag_stage_adc;
    reg [39:0] spec_max_other_mag_stage_adc;
    reg [39:0] spec_noise_mag_stage_adc;
    reg [1:0]  spec_peak_bin_stage_adc;
    ...
    reg [31:0] summary_spec_bin0_mag_axi;
    reg [31:0] summary_spec_bin1_mag_axi;
    reg [31:0] summary_spec_bin2_mag_axi;
    reg [31:0] summary_spec_bin3_mag_axi;
    reg [31:0] summary_spec_peak_mag_axi;
    reg [31:0] summary_spec_total_mag_axi;
    reg [31:0] summary_spec_noise_mag_axi;
    reg [31:0] summary_spec_prominence_axi;
    reg [31:0] summary_spec_limit_flags_axi;
    reg [1:0]  summary_spec_peak_bin_axi;
    reg        summary_spec_valid_axi;
    ...
    wire signed [47:0] i0_sum_next = i0_sum_adc + {{32{adc_i_stage_adc[15]}}, adc_i_stage_adc};
    wire signed [47:0] q0_sum_next = q0_sum_adc + {{32{adc_q_stage_adc[15]}}, adc_q_stage_adc};
    wire signed [47:0] i1_sum_next = i1_sum_adc + {{32{adc_i1_stage_adc[15]}}, adc_i1_stage_adc};
    wire signed [47:0] q1_sum_next = q1_sum_adc + {{32{adc_q1_stage_adc[15]}}, adc_q1_stage_adc};
    ...
    wire accept_sample_adc = adc_valid_stage_adc && adc_valid1_stage_adc && enable_sync_adc && !pending_adc && !frame_closing_adc;
    ...
    wire signed [31:0] cross_re_i_adc = adc_i_stage_adc * adc_i1_stage_adc;
    wire signed [31:0] cross_re_q_adc = adc_q_stage_adc * adc_q1_stage_adc;
    wire signed [31:0] cross_im_qi_adc = adc_q_stage_adc * adc_i1_stage_adc;
    wire signed [31:0] cross_im_iq_adc = adc_i_stage_adc * adc_q1_stage_adc;
    ...
    wire adc_i_clip = ((!adc_i_stage_adc[15]) && (&adc_i_stage_adc[14:4])) || (adc_i_stage_adc[15] && (~|adc_i_stage_adc[14:4]));
    wire adc_q_clip = ((!adc_q_stage_adc[15]) && (&adc_q_stage_adc[14:4])) || (adc_q_stage_adc[15] && (~|adc_q_stage_adc[14:4]));
    wire adc_i1_clip = ((!adc_i1_stage_adc[15]) && (&adc_i1_stage_adc[14:4])) || (adc_i1_stage_adc[15] && (~|adc_i1_stage_adc[14:4]));
    wire adc_q1_clip = ((!adc_q1_stage_adc[15]) && (&adc_q1_stage_adc[14:4])) || (adc_q1_stage_adc[15] && (~|adc_q1_stage_adc[14:4]));
    ...
    wire [15:0] rx0_i_zero_cross_count_next = rx0_i_zero_cross_count_adc + {15'd0, prev_valid_adc && (prev_i0_sign_adc != adc_i_stage_adc[15])};
    wire [15:0] rx0_q_zero_cross_count_next = rx0_q_zero_cross_count_adc + {15'd0, prev_valid_adc && (prev_q0_sign_adc != adc_q_stage_adc[15])};
    wire [15:0] rx1_i_zero_cross_count_next = rx1_i_zero_cross_count_adc + {15'd0, prev_valid_adc && (prev_i1_sign_adc != adc_i1_stage_adc[15])};
    wire [15:0] rx1_q_zero_cross_count_next = rx1_q_zero_cross_count_adc + {15'd0, prev_valid_adc && (prev_q1_sign_adc != adc_q1_stage_adc[15])};
    wire [15:0] same_i_sign_count_next = same_i_sign_count_adc + {15'd0, adc_i_stage_adc[15] == adc_i1_stage_adc[15]};
    wire [15:0] same_q_sign_count_next = same_q_sign_count_adc + {15'd0, adc_q_stage_adc[15] == adc_q1_stage_adc[15]};
    wire [15:0] i0q0_same_sign_count_next = i0q0_same_sign_count_adc + {15'd0, adc_i_stage_adc[15] == adc_q_stage_adc[15]};
    wire [15:0] i1q1_same_sign_count_next = i1q1_same_sign_count_adc + {15'd0, adc_i1_stage_adc[15] == adc_q1_stage_adc[15]};
    wire signed [31:0] adc_i_s32 = {{16{adc_i_stage_adc[15]}}, adc_i_stage_adc};
    wire signed [31:0] adc_q_s32 = {{16{adc_q_stage_adc[15]}}, adc_q_stage_adc};
    wire signed [31:0] spec_bin0_re_next = spec_bin0_re_adc + adc_i_s32;
    wire signed [31:0] spec_bin0_im_next = spec_bin0_im_adc + adc_q_s32;
    wire signed [31:0] spec_bin1_re_next =
        (sample_index_adc[1:0] == 2'd0) ? (spec_bin1_re_adc + adc_i_s32) :
        (sample_index_adc[1:0] == 2'd1) ? (spec_bin1_re_adc + adc_q_s32) :
        (sample_index_adc[1:0] == 2'd2) ? (spec_bin1_re_adc - adc_i_s32) :
                                           (spec_bin1_re_adc - adc_q_s32);
    wire signed [31:0] spec_bin1_im_next =
        (sample_index_adc[1:0] == 2'd0) ? (spec_bin1_im_adc + adc_q_s32) :
        (sample_index_adc[1:0] == 2'd1) ? (spec_bin1_im_adc - adc_i_s32) :
        (sample_index_adc[1:0] == 2'd2) ? (spec_bin1_im_adc - adc_q_s32) :
                                           (spec_bin1_im_adc + adc_i_s32);
    wire signed [31:0] spec_bin2_re_next = sample_index_adc[0] ? (spec_bin2_re_adc - adc_i_s32) : (spec_bin2_re_adc + adc_i_s32);
    wire signed [31:0] spec_bin2_im_next = sample_index_adc[0] ? (spec_bin2_im_adc - adc_q_s32) : (spec_bin2_im_adc + adc_q_s32);
    wire signed [31:0] spec_bin3_re_next =
        (sample_index_adc[1:0] == 2'd0) ? (spec_bin3_re_adc + adc_i_s32) :
        (sample_index_adc[1:0] == 2'd1) ? (spec_bin3_re_adc - adc_q_s32) :
        (sample_index_adc[1:0] == 2'd2) ? (spec_bin3_re_adc - adc_i_s32) :
                                           (spec_bin3_re_adc + adc_q_s32);
    wire signed [31:0] spec_bin3_im_next =
        (sample_index_adc[1:0] == 2'd0) ? (spec_bin3_im_adc + adc_q_s32) :
        (sample_index_adc[1:0] == 2'd1) ? (spec_bin3_im_adc + adc_i_s32) :
        (sample_index_adc[1:0] == 2'd2) ? (spec_bin3_im_adc - adc_q_s32) :
                                           (spec_bin3_im_adc - adc_i_s32);
    wire [32:0] spec_bin0_abs_re_next = spec_bin0_re_adc[31] ? {1'b0, ((~spec_bin0_re_adc) + 32'd1)} : {1'b0, spec_bin0_re_adc};
    wire [32:0] spec_bin0_abs_im_next = spec_bin0_im_adc[31] ? {1'b0, ((~spec_bin0_im_adc) + 32'd1)} : {1'b0, spec_bin0_im_adc};
    wire [32:0] spec_bin1_abs_re_next = spec_bin1_re_adc[31] ? {1'b0, ((~spec_bin1_re_adc) + 32'd1)} : {1'b0, spec_bin1_re_adc};
    wire [32:0] spec_bin1_abs_im_next = spec_bin1_im_adc[31] ? {1'b0, ((~spec_bin1_im_adc) + 32'd1)} : {1'b0, spec_bin1_im_adc};
    wire [32:0] spec_bin2_abs_re_next = spec_bin2_re_adc[31] ? {1'b0, ((~spec_bin2_re_adc) + 32'd1)} : {1'b0, spec_bin2_re_adc};
    wire [32:0] spec_bin2_abs_im_next = spec_bin2_im_adc[31] ? {1'b0, ((~spec_bin2_im_adc) + 32'd1)} : {1'b0, spec_bin2_im_adc};
    wire [32:0] spec_bin3_abs_re_next = spec_bin3_re_adc[31] ? {1'b0, ((~spec_bin3_re_adc) + 32'd1)} : {1'b0, spec_bin3_re_adc};
    wire [32:0] spec_bin3_abs_im_next = spec_bin3_im_adc[31] ? {1'b0, ((~spec_bin3_im_adc) + 32'd1)} : {1'b0, spec_bin3_im_adc};
    wire [33:0] spec_bin0_mag34_next = {1'b0, spec_bin0_abs_re_stage_adc} + {1'b0, spec_bin0_abs_im_stage_adc};
    wire [33:0] spec_bin1_mag34_next = {1'b0, spec_bin1_abs_re_stage_adc} + {1'b0, spec_bin1_abs_im_stage_adc};
    wire [33:0] spec_bin2_mag34_next = {1'b0, spec_bin2_abs_re_stage_adc} + {1'b0, spec_bin2_abs_im_stage_adc};
    wire [33:0] spec_bin3_mag34_next = {1'b0, spec_bin3_abs_re_stage_adc} + {1'b0, spec_bin3_abs_im_stage_adc};
    wire [39:0] spec_bin0_mag_stage_next = {6'd0, spec_bin0_mag34_next};
    wire [39:0] spec_bin1_mag_stage_next = {6'd0, spec_bin1_mag34_next};
    wire [39:0] spec_bin2_mag_stage_next = {6'd0, spec_bin2_mag34_next};
    wire [39:0] spec_bin3_mag_stage_next = {6'd0, spec_bin3_mag34_next};
    wire [39:0] spec_total_mag_stage_next = spec_bin0_mag_stage_adc + spec_bin1_mag_stage_adc + spec_bin2_mag_stage_adc + spec_bin3_mag_stage_adc;
    wire spec_pair01_bin0_ge_bin1 = (spec_bin0_mag_stage_adc >= spec_bin1_mag_stage_adc);
    wire spec_pair23_bin2_ge_bin3 = (spec_bin2_mag_stage_adc >= spec_bin3_mag_stage_adc);
    wire [39:0] spec_pair01_high_mag_next = spec_pair01_bin0_ge_bin1 ? spec_bin0_mag_stage_adc : spec_bin1_mag_stage_adc;
    wire [39:0] spec_pair01_low_mag_next = spec_pair01_bin0_ge_bin1 ? spec_bin1_mag_stage_adc : spec_bin0_mag_stage_adc;
    wire [39:0] spec_pair23_high_mag_next = spec_pair23_bin2_ge_bin3 ? spec_bin2_mag_stage_adc : spec_bin3_mag_stage_adc;
    wire [39:0] spec_pair23_low_mag_next = spec_pair23_bin2_ge_bin3 ? spec_bin3_mag_stage_adc : spec_bin2_mag_stage_adc;
    wire [1:0]  spec_pair01_high_bin_next = spec_pair01_bin0_ge_bin1 ? 2'd0 : 2'd1;
    wire [1:0]  spec_pair23_high_bin_next = spec_pair23_bin2_ge_bin3 ? 2'd2 : 2'd3;
    wire spec_peak_pair_is_01 = (spec_pair01_high_mag_stage_adc >= spec_pair23_high_mag_stage_adc);
    wire [39:0] spec_peak_mag_next = spec_peak_pair_is_01 ? spec_pair01_high_mag_stage_adc : spec_pair23_high_mag_stage_adc;
    wire [1:0]  spec_peak_bin_next = spec_peak_pair_is_01 ? spec_pair01_high_bin_stage_adc : spec_pair23_high_bin_stage_adc;
    wire [39:0] spec_peak_pair_low_mag = spec_peak_pair_is_01 ? spec_pair01_low_mag_stage_adc : spec_pair23_low_mag_stage_adc;
    wire [39:0] spec_other_pair_high_mag = spec_peak_pair_is_01 ? spec_pair23_high_mag_stage_adc : spec_pair01_high_mag_stage_adc;
    wire [39:0] spec_other_pair_low_mag = spec_peak_pair_is_01 ? spec_pair23_low_mag_stage_adc : spec_pair01_low_mag_stage_adc;
    wire [39:0] spec_max_other_next = (spec_peak_pair_low_mag >= spec_other_pair_high_mag) ? spec_peak_pair_low_mag : spec_other_pair_high_mag;
    wire [39:0] spec_noise_pair_min_next = (spec_peak_pair_low_mag <= spec_other_pair_high_mag) ? spec_peak_pair_low_mag : spec_other_pair_high_mag;
    wire [39:0] spec_noise_mag_next = (spec_noise_pair_min_next <= spec_other_pair_low_mag) ? spec_noise_pair_min_next : spec_other_pair_low_mag;
    wire [39:0] spec_prominence_next = (spec_peak_mag_stage_adc > spec_max_other_mag_stage_adc) ? (spec_peak_mag_stage_adc - spec_max_other_mag_stage_adc) : 40'd0;
    wire spec_bin0_saturate_next = |spec_bin0_mag_stage_adc[39:32];
    wire spec_bin1_saturate_next = |spec_bin1_mag_stage_adc[39:32];
    wire spec_bin2_saturate_next = |spec_bin2_mag_stage_adc[39:32];
    wire spec_bin3_saturate_next = |spec_bin3_mag_stage_adc[39:32];
    wire spec_total_saturate_next = |spec_total_mag_stage_adc[39:32];
    wire spec_prom_saturate_next = |spec_prominence_next[39:32];
    wire [31:0] spec_bin0_mag32_next = spec_bin0_saturate_next ? 32'hffffffff : spec_bin0_mag_stage_adc[31:0];
    wire [31:0] spec_bin1_mag32_next = spec_bin1_saturate_next ? 32'hffffffff : spec_bin1_mag_stage_adc[31:0];
    wire [31:0] spec_bin2_mag32_next = spec_bin2_saturate_next ? 32'hffffffff : spec_bin2_mag_stage_adc[31:0];
    wire [31:0] spec_bin3_mag32_next = spec_bin3_saturate_next ? 32'hffffffff : spec_bin3_mag_stage_adc[31:0];
    wire [31:0] spec_peak_mag32_next = (|spec_peak_mag_stage_adc[39:32]) ? 32'hffffffff : spec_peak_mag_stage_adc[31:0];
    wire [31:0] spec_total_mag32_next = spec_total_saturate_next ? 32'hffffffff : spec_total_mag_stage_adc[31:0];
    wire [31:0] spec_noise_mag32_next = (|spec_noise_mag_stage_adc[39:32]) ? 32'hffffffff : spec_noise_mag_stage_adc[31:0];
    wire [31:0] spec_prominence32_next = spec_prom_saturate_next ? 32'hffffffff : spec_prominence_next[31:0];
    wire [31:0] spec_limit_flags_next = {26'd0, spec_prom_saturate_next, spec_total_saturate_next, spec_bin3_saturate_next, spec_bin2_saturate_next, spec_bin1_saturate_next, spec_bin0_saturate_next};
    wire spec_valid_next = (post_sample_count_adc != 16'd0);
    ...
    always @(posedge adc_clk) begin
        if (adc_rst) begin
            ...
            clear_seen_adc <= 1'b0;
            pending_adc <= 1'b0;
            adc_i_stage_adc <= 16'sd0;
            adc_q_stage_adc <= 16'sd0;
            adc_i1_stage_adc <= 16'sd0;
            adc_q1_stage_adc <= 16'sd0;
            adc_valid_stage_adc <= 1'b0;
            adc_valid1_stage_adc <= 1'b0;
            ...
            spec_bin0_re_adc <= 32'sd0;
            spec_bin0_im_adc <= 32'sd0;
            spec_bin1_re_adc <= 32'sd0;
            spec_bin1_im_adc <= 32'sd0;
            spec_bin2_re_adc <= 32'sd0;
            spec_bin2_im_adc <= 32'sd0;
            spec_bin3_re_adc <= 32'sd0;
            spec_bin3_im_adc <= 32'sd0;
            summary_spec_bin0_mag_adc <= 32'd0;
            summary_spec_bin1_mag_adc <= 32'd0;
            summary_spec_bin2_mag_adc <= 32'd0;
            summary_spec_bin3_mag_adc <= 32'd0;
            summary_spec_peak_mag_adc <= 32'd0;
            summary_spec_total_mag_adc <= 32'd0;
            summary_spec_noise_mag_adc <= 32'd0;
            summary_spec_prominence_adc <= 32'd0;
            summary_spec_limit_flags_adc <= 32'd0;
            summary_spec_peak_bin_adc <= 2'd0;
            summary_spec_valid_adc <= 1'b0;
            spec_bin0_abs_re_stage_adc <= 33'd0;
            spec_bin0_abs_im_stage_adc <= 33'd0;
            spec_bin1_abs_re_stage_adc <= 33'd0;
            spec_bin1_abs_im_stage_adc <= 33'd0;
            spec_bin2_abs_re_stage_adc <= 33'd0;
            spec_bin2_abs_im_stage_adc <= 33'd0;
            spec_bin3_abs_re_stage_adc <= 33'd0;
            spec_bin3_abs_im_stage_adc <= 33'd0;
            spec_bin0_mag_stage_adc <= 40'd0;
            spec_bin1_mag_stage_adc <= 40'd0;
            spec_bin2_mag_stage_adc <= 40'd0;
            spec_bin3_mag_stage_adc <= 40'd0;
            spec_total_mag_stage_adc <= 40'd0;
            spec_pair01_high_mag_stage_adc <= 40'd0;
            spec_pair01_low_mag_stage_adc <= 40'd0;
            spec_pair23_high_mag_stage_adc <= 40'd0;
            spec_pair23_low_mag_stage_adc <= 40'd0;
            spec_pair01_high_bin_stage_adc <= 2'd0;
            spec_pair23_high_bin_stage_adc <= 2'd2;
            spec_peak_mag_stage_adc <= 40'd0;
            spec_max_other_mag_stage_adc <= 40'd0;
            spec_noise_mag_stage_adc <= 40'd0;
            spec_peak_bin_stage_adc <= 2'd0;
        end else begin
            ...
            adc_i_stage_adc <= adc_i;
            adc_q_stage_adc <= adc_q;
            adc_i1_stage_adc <= adc_i1;
            adc_q1_stage_adc <= adc_q1;
            adc_valid_stage_adc <= adc_valid;
            adc_valid1_stage_adc <= adc_valid1;
            ...
            if (clear_sync_adc != clear_seen_adc) begin
                ...
                if (accept_sample_adc) begin
                    ...
                    i_square_adc <= adc_i_stage_adc * adc_i_stage_adc;
                    q_square_adc <= adc_q_stage_adc * adc_q_stage_adc;
                    i1_square_adc <= adc_i1_stage_adc * adc_i1_stage_adc;
                    q1_square_adc <= adc_q1_stage_adc * adc_q1_stage_adc;
                    ...
                    spec_bin0_re_adc <= spec_bin0_re_next;
                    spec_bin0_im_adc <= spec_bin0_im_next;
                    spec_bin1_re_adc <= spec_bin1_re_next;
                    spec_bin1_im_adc <= spec_bin1_im_next;
                    spec_bin2_re_adc <= spec_bin2_re_next;
                    spec_bin2_im_adc <= spec_bin2_im_next;
                    spec_bin3_re_adc <= spec_bin3_re_next;
                    spec_bin3_im_adc <= spec_bin3_im_next;
                    ...
                    prev_valid_adc <= 1'b1;
                    prev_i0_sign_adc <= adc_i_stage_adc[15];
                    prev_q0_sign_adc <= adc_q_stage_adc[15];
                    prev_i1_sign_adc <= adc_i1_stage_adc[15];
                    prev_q1_sign_adc <= adc_q1_stage_adc[15];
                    if (frame_done) begin
                ...
                case (post_state_adc)
                    ...
                    4'd3: begin
                        ...
                        spec_bin0_abs_re_stage_adc <= spec_bin0_abs_re_next;
                        spec_bin0_abs_im_stage_adc <= spec_bin0_abs_im_next;
                        spec_bin1_abs_re_stage_adc <= spec_bin1_abs_re_next;
                        spec_bin1_abs_im_stage_adc <= spec_bin1_abs_im_next;
                        spec_bin2_abs_re_stage_adc <= spec_bin2_abs_re_next;
                        spec_bin2_abs_im_stage_adc <= spec_bin2_abs_im_next;
                        spec_bin3_abs_re_stage_adc <= spec_bin3_abs_re_next;
                        spec_bin3_abs_im_stage_adc <= spec_bin3_abs_im_next;
                        post_state_adc <= 4'd4;
                    end
                    4'd4: begin
                        spec_bin0_mag_stage_adc <= spec_bin0_mag_stage_next;
                        spec_bin1_mag_stage_adc <= spec_bin1_mag_stage_next;
                        spec_bin2_mag_stage_adc <= spec_bin2_mag_stage_next;
                        spec_bin3_mag_stage_adc <= spec_bin3_mag_stage_next;
                        post_state_adc <= 4'd5;
                    end
                    4'd5: begin
                        spec_total_mag_stage_adc <= spec_total_mag_stage_next;
                        spec_pair01_high_mag_stage_adc <= spec_pair01_high_mag_next;
                        spec_pair01_low_mag_stage_adc <= spec_pair01_low_mag_next;
                        spec_pair23_high_mag_stage_adc <= spec_pair23_high_mag_next;
                        spec_pair23_low_mag_stage_adc <= spec_pair23_low_mag_next;
                        spec_pair01_high_bin_stage_adc <= spec_pair01_high_bin_next;
                        spec_pair23_high_bin_stage_adc <= spec_pair23_high_bin_next;
                        post_state_adc <= 4'd6;
                    end
                    4'd6: begin
                        spec_peak_mag_stage_adc <= spec_peak_mag_next;
                        spec_max_other_mag_stage_adc <= spec_max_other_next;
                        spec_noise_mag_stage_adc <= spec_noise_mag_next;
                        spec_peak_bin_stage_adc <= spec_peak_bin_next;
                        post_state_adc <= 4'd7;
                    end
                    4'd7: begin
                        summary_spec_bin0_mag_adc <= spec_bin0_mag32_next;
                        summary_spec_bin1_mag_adc <= spec_bin1_mag32_next;
                        summary_spec_bin2_mag_adc <= spec_bin2_mag32_next;
                        summary_spec_bin3_mag_adc <= spec_bin3_mag32_next;
                        summary_spec_peak_mag_adc <= spec_peak_mag32_next;
                        summary_spec_total_mag_adc <= spec_total_mag32_next;
                        summary_spec_noise_mag_adc <= spec_noise_mag32_next;
                        summary_spec_prominence_adc <= spec_prominence32_next;
                        summary_spec_limit_flags_adc <= spec_limit_flags_next;
                        summary_spec_peak_bin_adc <= spec_peak_bin_stage_adc;
                        summary_spec_valid_adc <= spec_valid_next;
                        if (agg_enable_sync_adc && !agg_done_adc && corrected_valid_next_adc) begin
                        ...
                        end else if (agg_enable_sync_adc && !agg_done_adc) begin
                            agg_overflow_adc <= 1'b1;
                            agg_latched_done_adc <= 1'b1;
    ...
    always @(posedge s_axi_aclk) begin
        ...
        if (!s_axi_aresetn_ctrl_axi) begin
            ...
            summary_spec_bin0_mag_axi <= 32'd0;
            summary_spec_bin1_mag_axi <= 32'd0;
            summary_spec_bin2_mag_axi <= 32'd0;
            summary_spec_bin3_mag_axi <= 32'd0;
            summary_spec_peak_mag_axi <= 32'd0;
            summary_spec_total_mag_axi <= 32'd0;
            summary_spec_noise_mag_axi <= 32'd0;
            summary_spec_prominence_axi <= 32'd0;
            summary_spec_limit_flags_axi <= 32'd0;
            summary_spec_peak_bin_axi <= 2'd0;
            summary_spec_valid_axi <= 1'b0;
            ...
            if (pending_sync_axi && !pending_sync_axi_d) begin
                ...
                summary_spec_bin0_mag_axi <= summary_spec_bin0_mag_adc;
                summary_spec_bin1_mag_axi <= summary_spec_bin1_mag_adc;
                summary_spec_bin2_mag_axi <= summary_spec_bin2_mag_adc;
                summary_spec_bin3_mag_axi <= summary_spec_bin3_mag_adc;
                summary_spec_peak_mag_axi <= summary_spec_peak_mag_adc;
                summary_spec_total_mag_axi <= summary_spec_total_mag_adc;
                summary_spec_noise_mag_axi <= summary_spec_noise_mag_adc;
                summary_spec_prominence_axi <= summary_spec_prominence_adc;
                summary_spec_limit_flags_axi <= summary_spec_limit_flags_adc;
                summary_spec_peak_bin_axi <= summary_spec_peak_bin_adc;
                summary_spec_valid_axi <= summary_spec_valid_adc;
            end

            if (!axi_wr_pending && !s_axi_bvalid && s_axi_awvalid && s_axi_wvalid) begin
                s_axi_awready <= 1'b1;
                s_axi_wready <= 1'b1;
                axi_wr_addr <= s_axi_awaddr[11:0];
                axi_wr_data <= s_axi_wdata;
                axi_wr_strb <= s_axi_wstrb;
                axi_wr_pending <= 1'b1;
            end

            if (axi_wr_pending && !s_axi_bvalid) begin
                s_axi_bresp <= 2'b00;
                s_axi_bvalid <= 1'b1;
                axi_wr_pending <= 1'b0;
                ...
                case (axi_wr_addr)
                    REG_CONTROL: begin
                        if (axi_wr_strb[0]) begin
                            control_shadow_axi <= axi_wr_data;
                            enable_axi <= axi_wr_data[0];
                            if (axi_wr_data[1]) begin
                    ...
                    REG_FRAME_LEN: begin
                        if (|axi_wr_strb) begin
                            frame_len_shadow_axi <= axi_wr_data;
                            frame_len_axi <= (axi_wr_data[15:0] == 16'd0) ? 16'd1 : axi_wr_data[15:0];
                        end
                    end
                    REG_SNAPSHOT_INDEX: begin
                        if (|axi_wr_strb) begin
                            snapshot_index_axi <= axi_wr_data[5:0];
                        end
                    end
                    REG_AGG_CONTROL: begin
                        if (axi_wr_strb[0]) begin
                            agg_control_shadow_axi <= axi_wr_data;
                            agg_enable_axi <= axi_wr_data[0];
                            if (axi_wr_data[1]) begin
                    ...
                    REG_AGG_TARGET: begin
                        if (|axi_wr_strb) begin
                            agg_target_frames_axi <= (axi_wr_data[15:0] == 16'd0) ? 16'd1 : axi_wr_data[15:0];
                        end
                    end
                    default: begin
                    end
        ...
        if (!s_axi_aresetn_read_axi) begin
            ...
            if (!s_axi_rvalid && s_axi_arvalid) begin
                ...
                case (s_axi_araddr[11:0])
                    ...
                    REG_SUMMARY_VERSION:  s_axi_rdata <= SUMMARY_VERSION_SUM9;
                    ...
                    REG_QUALITY_VERSION:  s_axi_rdata <= QUALITY_VERSION_SUM9;
                    ...
                    REG_AGG_VERSION:      s_axi_rdata <= AGG_VERSION_SUM9;
                    REG_AGG_CONTROL:      s_axi_rdata <= {26'd0, agg_overflow_axi, agg_done_axi, 2'd0, 1'b0, agg_enable_axi};
                    ...
                    REG_SPEC_VERSION:     s_axi_rdata <= SPEC_VERSION_SUM9;
                    REG_SPEC_FLAGS:       s_axi_rdata <= {24'd0, 1'b0, (summary_spec_prominence_axi > (summary_spec_peak_mag_axi >> 1)), (summary_spec_prominence_axi <= (summary_spec_peak_mag_axi >> 2)), (summary_spec_total_mag_axi == 32'd0), (summary_sample_count_axi[1:0] != 2'd0), (|summary_spec_limit_flags_axi[5:0]), (enable_axi && !pending_sync_axi), summary_spec_valid_axi};
                    REG_SPEC_FRAME:       s_axi_rdata <= summary_frame_count_axi;
                    REG_SPEC_SAMPLES:     s_axi_rdata <= {16'd0, summary_sample_count_axi};
                    REG_SPEC_PEAK_BIN:    s_axi_rdata <= {30'd0, summary_spec_peak_bin_axi};
                    REG_SPEC_PEAK_POWER:  s_axi_rdata <= summary_spec_peak_mag_axi;
                    REG_SPEC_TOTAL_POWER: s_axi_rdata <= summary_spec_total_mag_axi;
                    REG_SPEC_NOISE_FLOOR: s_axi_rdata <= summary_spec_noise_mag_axi;
                    REG_SPEC_PROMINENCE:  s_axi_rdata <= summary_spec_prominence_axi;
                    REG_SPEC_BIN0_POWER:  s_axi_rdata <= summary_spec_bin0_mag_axi;
                    REG_SPEC_BIN1_POWER:  s_axi_rdata <= summary_spec_bin1_mag_axi;
                    REG_SPEC_BIN2_POWER:  s_axi_rdata <= summary_spec_bin2_mag_axi;
                    REG_SPEC_BIN3_POWER:  s_axi_rdata <= summary_spec_bin3_mag_axi;
                    REG_SPEC_LIMIT_FLAGS: s_axi_rdata <= summary_spec_limit_flags_axi;
                    REG_SPEC_RX_MASK:     s_axi_rdata <= 32'h00000001;
                    REG_SPEC_RESERVED0:   s_axi_rdata <= 32'd0;
                    REG_SPEC_BIN_COUNT:   s_axi_rdata <= SPEC_BIN_COUNT_VALUE;
                    REG_SPEC_CAP:         s_axi_rdata <= SPEC_CAPABILITY;
                    REG_SPEC_BUILD_ID:    s_axi_rdata <= SPEC_BUILD_ID;
                    REG_SPEC_ABI_VERSION: s_axi_rdata <= SPEC_ABI_VERSION;
